...
install: $(CLI_TARGETS) $(SIM_TARGETS)
	...
	cp misa-harness/constants.py misa-harness/clock.py misa-harness/ram.py misa-harness/bus.py misa-harness/peripheral.py misa-harness/interrupt.py misa-harness/uart.py misa-harness/timer.py misa-harness/machine.py misa-harness/uart_console.py $(INSTALL_DIR)
